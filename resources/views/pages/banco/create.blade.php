...
<div class="modal fade" id="bancos-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-big" role="document" >
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="bancos-label"></h4>
            </div>
            <div class="loader text-center">
                <i class="fa fa-refresh fa-spin fa-3x fa-fw"></i>
                <span class="sr-only">Loading...</span>
            </div>
            <form class="form-horizontal hidden" method="POST" id='bancos-form' >
                {!! csrf_field() !!}
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-lg-offset-2 col-sm-6 col-xs-12">
                                                ...
                                                <input type="text" class="form-control" name="nombre" id="nombre" maxlength="{{\App\Models\Banco::MAX_LENGTH_NOMBRE}}" required />
                                            </div>
                                        </div>          
                                    </td>
                                </tr>
